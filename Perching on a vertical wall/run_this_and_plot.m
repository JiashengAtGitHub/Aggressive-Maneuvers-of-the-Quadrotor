clear all;close all
x_0=[-4.835 0 -2.607, 0 0 0, 0 0 0, 0 0 0]'; %  specify your initial conditon
m=3;
g=9.81;
...
% data
step=1;
x_all=[x_phase2(1:end-1,:);x_phase3]; % pay attention
...
for i=[1:50:201 226]                     % pay attention
...
% plot3([0.2 0.2],[-0.6 0.6],[0 0],'k-','LineWidth',3)
 % vertical window
% plot3([-0.2 0.2],[0 0],[-0.6 -0.6],'k-','LineWidth',2)
% plot3([-0.2 0.2],[0 0],[0.6 0.6],'k-','LineWidth',2)
% plot3([-0.2 -0.2],[0 0],[-0.6 0.6],'k-','LineWidth',2)
% plot3([0.2 0.2],[0 0],[-0.6 0.6],'k-','LineWidth',2)
 % vertical wall
