clear all;close all
x_0=[0 0 1, 0 0 0, pi/18 pi/18 pi/18, 0 0 0]'; %  specify your initial conditon
m=3;
g=9.81;
...
% data
step=1;
x_all=[x_phase2(1:end-1,:);x_phase3(1:end-1,:);x_phase4(1:end-1,:);x_phase5]; % pay attention: source: x_all=[x_phase3(1:end-1,:);x_step3]
...
for i=[(1:50:201) (201:25:251) [251 261 276] (276:50:426)]                             % pay attention
...
% horizontal window 
 ...
 plot3([0.2 0.2],[-0.6 0.6],[0 0],'k-','LineWidth',3)
 % vertical window
% plot3([0 0],[-0.2 0.2],[-0.6 -0.6],'k-','LineWidth',2)
% plot3([0 0],[-0.2 0.2],[0.6 0.6],'k-','LineWidth',2)
% plot3([0 0],[-0.2 -0.2],[-0.6 0.6],'k-','LineWidth',2)
% plot3([0 0],[0.2 0.2],[-0.6 0.6],'k-','LineWidth',2)
